 ...
 */
class IChat implements Chat, HasIdGenerator, Spied
{
    ...
    protected function initNewScope(GhtSession $session) : void
    {
    ...
    protected function restoreScope(GhtSession $session) : void
    {
        $ghostInput = $session->ghostInput;
    ...
    {
        return printf(static::CHAT_LOCKER_KEY, $this->getChatId());
    }
