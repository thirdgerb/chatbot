 ...
 */
class IProcessBack implements Process, HasIdGenerator
{
    ...
    public function await(Waiter $waiter): void
    {
    ...
    public function addDepending(string $ucl, string $dependedContextId): void
    {
