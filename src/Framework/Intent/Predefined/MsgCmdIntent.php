...
class MsgCmdIntent extends Intent
{
    ...
    public function __construct(string $commandText, Message $message)
    {
        $this->tokens = $this->tokenize($commandText);
        $commandName = array_shift($this->tokens);
    ...
    {
        $this->arguments = [];
        parent::bind($definition); // TODO: Change the autogenerated stub
    }
