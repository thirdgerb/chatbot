 ...
 */
class ICommandDef implements CommandDef
{
    ...
    public static function makeBySignature(string $signature) : ICommandDef
    {
         ...
         */
        $definition = new ICommandDef($name);
        $arguments = $arguments ?? [];
        $options = $options ?? [];
    ...
    {
        return new ICommandMsg($cmdText, $this);
    }
