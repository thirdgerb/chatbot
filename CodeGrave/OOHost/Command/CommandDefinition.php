...
class CommandDefinition
{
     ...
     */
    public function __construct(string $commandName, array $definition = [])
    {
        $this->commandName = $commandName;
        $this->setDefinition($definition);
    }

    public static function makeBySignature(string $signature) : CommandDefinition
    {
    ...
    public function toCommandMessage(string $cmdText, Message $message) : CommandMessage
    {
        return new CommandMessage($cmdText, $message, $this);
    }
